...
{
    public class UpperLayerConfiguration
    {
        private RubiksColor?[,] _face;

        public UpperLayerConfiguration(IEnumerable<Cubie> face)
        {
        ...
        public UpperLayerConfiguration(RubiksColor?[,] config)
        {
            _face = config;
        }

        public bool Matches(UpperLayerConfiguration configuration)
        {
